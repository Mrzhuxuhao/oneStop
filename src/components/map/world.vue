...
import mapData from '../../components/map/woeld'
   ...
   methods:{
     showChina(){
       var columns = [
          ...
          ["Population density 2010",53,117,15,342,181,15,202,15,109,597,3,102,110,34,1660,1142,636,47,359,15,80,1292,19,9,73,4,23,76,69,60,326,80,41,4,123,234,7,9,23,143,42,395,29,12,91,62,79,106,321,119,136,131,38,90,205,58,81,299,25,52,32,83,35,47,18,118,74,6,173,78,234,107,88,0,307,333,134,41,54,4,363,68,6783,112,3,394,132,45,73,65,145,352,206,250,350,69,6,71,123,202,504,167,154,28,27,36,413,72,41,4,225,53,195,19416,82,36,158,86,1053,13,1291,300,3,631,552,58,159,124,17704,2,47,72,30,73,3,209,492,14,17,48,12,174,132,16,9,225,45,47,15,16,23,313,126,116,449,152,93,9,431,65,526,172,14,65,83,188,82,7252,113,102,19,15,41,null,92,333,202,285,556,280,18,3,69,23,196,111,49,51,135,76,111,145,261,68,95,11,40,328,170,79,90,257,34,19,66,20,33,280,314,690,2,46,17,32]
        ];
        // Read the columns into the data array
        var data = [];
        Highchart.each(columns[0], function (code, i) {
          data.push({
       ...
       var map = Highchart.mapChart('container', {
          chart : {
            borderWidth : 1
          },
          ...
          legend: {
            title: {
              text: '个数',
              style: {
                color: (Highchart.theme && Highchart.theme.textColor) || 'black'
              }
            },
            align: 'left',
            ...
            layout: 'vertical',
            valueDecimals: 0,
            backgroundColor: (Highchart.theme && Highchart.theme.legendBackgroundColor) || 'rgba(255, 255, 255, 0.85)',
            symbolRadius: 0,
            symbolHeight: 14
          },
          colorAxis: {
